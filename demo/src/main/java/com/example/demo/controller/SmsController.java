...
public class SmsController {
    ...
    public MultipleDetailMessageSentResponse sendMmsByResourcePath() throws IOException, SolapiMessageNotReceivedException, SolapiUnknownException, SolapiEmptyResponseException {
    ...
    public MultipleDetailMessageSentResponse sendScheduledMessages() {
        ...
        try {
            ...
            LocalDateTime localDateTime = LocalDateTime.parse("2025-08-20 00:00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
